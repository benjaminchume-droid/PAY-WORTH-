            ...
            <div className="mt-5 pt-5 border-t border-white/10 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <button
                  ...
                  disabled={loading}
                  className="bg-white/5 hover:bg-white/10 border border-white/10 text-white text-xs font-semibold py-2.5 px-3 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
                >
