          ...
          {mode !== 'forgot' && mode !== 'reset' && (
            <div className="mt-5 pt-5 border-t border-white/5 text-center">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2.5 bg-white/5 hover:bg-white/10 active:scale-95 text-white font-medium text-xs py-3 rounded-xl transition-all border border-white/10 cursor-pointer"
              >
