    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans p-4 md:p-8 max-w-2xl mx-auto space-y-6 pb-28">
      ...
      <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 space-y-4 shadow-xl">
        ...
        <div className="space-y-2.5">
          ...
          <div className="bg-slate-950/60 border border-white/5 p-3.5 rounded-2xl flex items-center justify-between text-xs">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#1877F2]/10 border border-[#1877F2]/20 text-[#1877F2] flex items-center justify-center">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </div>
              <div>
                <span className="font-bold text-white block">Facebook Login</span>
                <span className="text-[10px] text-slate-400 font-mono">Social Single Sign-On</span>
              </div>
            </div>

            <span className="text-[11px] font-mono font-bold text-slate-400">Ready</span>
          </div>
        </div>
      </div>
